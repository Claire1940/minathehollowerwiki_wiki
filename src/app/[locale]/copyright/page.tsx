...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Mina the Hollower Wiki',
    description: 'Copyright and intellectual property information for Mina the Hollower Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Mina the Hollower Wiki',
      description: 'Copyright and intellectual property information for Mina the Hollower Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Mina the Hollower Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Mina the Hollower Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Mina the Hollower Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Mina the Hollower Developers</strong> - Creators of the Mina the Hollower game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Mina the Hollower</strong> - Trademark of the game developers</li>
              <li><strong>Mina the Hollower Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Mina the Hollower Wiki.
            </p>
            ...
            <p>
              ...
              Mina the Hollower Wiki<br />
              Email: <a href="mailto:dmca@minathehollowerwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@minathehollowerwiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Mina the Hollower Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Mina the Hollower Wiki (minathehollowerwiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@minathehollowerwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@minathehollowerwiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@minathehollowerwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@minathehollowerwiki.wiki</a>
            </p>
            <p>
