...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = 'Mina the Hollower Wiki - Walkthrough, Bosses, Trinkets & Achievements'
  const description =
    'Mina the Hollower Wiki with release date updates, walkthrough routes, boss strategies, weapon and trinket guides, achievements, and randomizer tips.'
      ...
      images: [
        {
          ...
          width: 1920,
          height: 1080,
          alt: 'Mina the Hollower hero art',
        },
      ],
    },
    twitter: {
